...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
      className={cn(
        "fixed z-50 inset-x-0 bottom-0 mt-24 h-auto rounded-t-lg border bg-background p-6 shadow-lg data-[state=open]:animate-in data-[state=open]:slide-in-from-bottom-full data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom-full",
        className
      )}
    >
      {children}
